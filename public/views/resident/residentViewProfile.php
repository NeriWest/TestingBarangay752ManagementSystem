            ...
            <div class="sidebar-footer">
                ...
                <?php
                        if (!empty($personalAccount['profile_image_name'])) {
                            ...
                            echo "<img src='../../img/profile_images/" . htmlspecialchars($personalAccount['profile_image_name'], ENT_QUOTES) . "' alt='Profile Image' class='sidebar-profile-image'>";
                            echo "</a>";
                        } else {
                            echo "<a href='../../img/id_images/default.jpg' target='_blank'>";
                            echo "<img src='../../img/id_images/default.jpg' alt='Default Profile Image' class='sidebar-profile-image'>";
                            echo "</a>";
                        }
                        ?>
                ...
                <section class="showcase">
                    ...
                    <div class="profile-container">
                        ...
                        <div id="account" class="tab-content active">
                            ...
                            <form id="accountForm" action="residentViewProfileController.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($personalAccount['email']) ?>" required>
                        ...
                        <div id="resident" class="tab-content">
                            <form id="residentForm" action="residentViewProfileController.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
