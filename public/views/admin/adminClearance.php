...
<header class="main-head active">
            ...
            <h1 id="table-title" style="font-size: 30px; margin-bottom: 20px">Clearance List</h1>
            ...
            <div class="table-container">
                ...
                <thead>
                    ...
                    <td colspan="14" class="search-column">
                        ...
                        <button class="modal-open-add button" onclick="" id="add-permit">Issue Clearance +</button>
                        <?php
                        $approvedCount = 0;
                        $disapprovedCount = 0;
                        $pendingCount = 0;
            ...
            <div class="modal-overlay-add">
                <div class="modal-add" id="accessible-modal-add" role="dialog" aria-modal="true" aria-labelledby="modal-title-add" aria-describedby="modal-description-add">
                    <div class="modal-header-add">
                        <h2 id="modal-title-add">Issue Clearance</h2>
                        <button class="modal-close-add" aria-label="Close modal">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-content-add">
                        <form id="addForm-add" action="adminClearanceController.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm();">
                            ...
                            <div class="form-group-add">
                                ...
                                <textarea id="add-purpose-add" name="purpose" placeholder="Enter the purpose of the document" required style="width: 99%; height: 150px; resize: none;"></textarea>
                            </div>
                            ...
                            <input type="submit" class="button-add" value="Add Clearance">
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-overlay">
                <div class="modal" id="accessible-modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-description">
                    <div class="modal-header">
                        <h2 id="modal-title">Show Clearance</h2>
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    $('#searchInput').on('keyup', function() {
                        ...
                        $.ajax({
                            url: 'adminClearanceSearch.php', // Ensure this is the correct path to your PHP file
                            method: 'POST',
                            cache: false,
                ...
                function populateModal(button) {
                    ...
                    document.getElementById('edit-remarks').value = remarks ? remarks : 'No remarks';
