...
<header class="main-head active">
        ...
        <section class="showcase">
            ...
            <h1 id="table-title" style="font-size: 30px; margin-bottom: 20px">Incident List</h1>
                            ...
                            <tr>
                                <td colspan="15" class="search-column">
                                    <div class="search-bar">
                                        <p>Search</p>
                                        <input type="text" placeholder="Search Incident" id="searchInput">
                                        <!-- <button class="modal-open-add button" onclick="newEntry()" id="add-resident">Add Incident +</button> -->
                                        <?php
                                        $resolvedCount = 0;
                                        $closedCount = 0;
                                        $pendingCount = 0;
            ...
            <div id="resolvePopup" class="popup-overlay">
                <div class="popup-content">
                    <h2>Confirm Incident Resolution</h2>
                    <p>Are you sure you want to resolve this incident case?</p>
            ...
            <div id="closePopup" class="popup-overlay">
                <div class="popup-content">
                    <h2>Confirm Incident Closure</h2>
                    <p>Are you sure you want to close this incident case? Please provide a reason for closure.</p>
                    <form id="closeForm" action="closeReportController.php" method="POST">
                        <input type="hidden" name="incident_id" id="close-incident-id" value="">
                        <input type="hidden" name="report_type" value="incident"> 
            ...
            function showResolvePopup(caseId) {
                document.getElementById("resolve-incident-id").value = caseId;
            ...
            function showClosePopup(caseId) {
                document.getElementById("close-incident-id").value = caseId;
            ...
            <div class="modal-overlay-add">
                <div class="modal-add" id="accessible-modal-add" role="dialog" aria-modal="true" aria-labelledby="modal-title-add" aria-describedby="modal-description-add">
                    <div class="modal-header-add">
                        <h2 id="modal-title-add">Add Incident</h2>
                        <button class="modal-close-add" aria-label="Close modal">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-content-add">
                        <form id="addComplaintForm-add" action="adminIncidentController.php" method="POST" enctype="multipart/form-data">
                            <!-- Hidden Account ID -->
                            ...
                            <div class="form-group-add">
                                ...
                                <textarea id="narration-add" name="narration" placeholder="Describe the incident" required maxlength="200" style="width: 99%; height: 150px; resize: none;"
                                ></textarea>
                            </div>
                            ...
                            <div class="form-group-add">
                                ...
                                <select id="status-add" name="status" required>
            ...
            <div class="modal-overlay">
                <div class="modal" id="accessible-modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-description">
                    <div class="modal-header">
                        <h2 id="modal-title">Update Incident</h2>
                        <button class="modal-close" aria-label="Close modal">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-content">
                    <form id="edit-blotter-form" action="adminIncidentUpdate.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" id="edit-status" name="status" placeholder="" readonly>
                        </div>
                        <!-- Evidence Description -->
                        <div class="form-group-add">
                            <label for="edit-evidence-description">Evidence Name</label>
                            <input type="text" id="edit-evidence-description" name="evidence_description" placeholder="Enter evidence title" maxlength="200" readonly>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#searchInput').on('keyup', function() {
            ...
            $.ajax({
                url: 'adminIncidentSearch.php', // Ensure this is the correct path to your PHP file
                method: 'POST',
                cache: false,
                ...
                success: function(data) {
                    ...
                    $('.modal-open').on('click', function() {
                        let caseId = $(this).data('incident-id');
                        console.log("Clicked Case ID: " + incidentId); // Debugging: check if the click event is captured
...
function populateIncidentModal(button) {
    ...
    var basePath = '../../img/image_evidences/incident/';  // Ensure this matches your server structure
