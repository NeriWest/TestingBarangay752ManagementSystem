...
<header class="main-head active">
        ...
        <section class="showcase">
            ...
            <h1 id="table-title" style="font-size: 30px; margin-bottom: 20px">Blotter List</h1>
                            ...
                            <tr>
                                <td colspan="15" class="search-column">
                                    <div class="search-bar">
                                        <p>Search</p>
                                        <input type="text" placeholder="Search Blotter" id="searchInput">
                                        <button class="modal-open-add button" onclick="newEntry()" id="add-blotter">Add Blotter +</button>
                                        <?php
                                        $resolvedCount = 0;
                                        $closedCount = 0;
                                        $pendingCount = 0;
            ...
            <div id="resolvePopup" class="popup-overlay">
                <div class="popup-content">
                    <h2>Confirm Blotter Resolution</h2>
                    <p>Are you sure you want to resolve this blotter case?</p>
                    <form id="resolveForm" action="resolveReportController.php" method="POST">
                        <input type="hidden" name="case_id" id="resolve-case-id">
                        <input type="hidden" name="report_type" value="blotter"> 
            ...
            <div id="closePopup" class="popup-overlay">
                <div class="popup-content">
                    <h2>Confirm Blotter Closure</h2>
                    <p>Are you sure you want to close this blotter case? Please provide a reason for closure.</p>
                    <form id="closeForm" action="closeReportController.php" method="POST">
                        <input type="hidden" name="case_id" id="close-case-id" value="<?php echo htmlspecialchars($blotter['case_id']); ?>">
                        <input type="hidden" name="report_type" value="blotter"> 
            ...
            <div class="modal-overlay-add">
                <div class="modal-add" id="accessible-modal-add" role="dialog" aria-modal="true" aria-labelledby="modal-title-add" aria-describedby="modal-description-add">
                    <div class="modal-header-add">
                        <h2 id="modal-title-add">Add Blotter</h2>
                        <button class="modal-close-add" aria-label="Close modal">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-content-add">
                        <form id="addBlotterForm-add" action="adminBlotterController.php" method="POST" enctype="multipart/form-data">
                            <!-- Hidden Account ID -->
                            ...
                            <div class="form-group-add">
                                ...
                                <input type="text" id="resident-search-main" placeholder="Search Residents" autocomplete="off" class="form-control-add" onkeyup="filterResidents()">
                                ...
                                <script>
                                    function filterResidents() {
                                        const searchInput = document.getElementById('resident-search-main').value.toLowerCase();
                                        const residentOptions = document.getElementById('add-residents-add').options;

                                        for (let i = 0; i < residentOptions.length; i++) {
                                            const optionText = residentOptions[i].textContent.toLowerCase();
                                            if (optionText.includes(searchInput) || residentOptions[i].value === "") {
                                                residentOptions[i].style.display = "";
                                            } else {
                                                residentOptions[i].style.display = "none";
                                            }
                                        }
                                    }
                                </script>
                            ...
                            <div class="form-group-add">
                                ...
                                <textarea id="narration-add" name="narration" rows="5" placeholder="Describe the incident" required 
                            ...
                            <div class="form-group-add">
                                ...
                                <!-- Status -->
                                <input type="hidden" id="status-add" name="status" value="<?php echo 'pending'; ?>">
                          
                            <input type="submit" class="button-add" value="Add Blotter">
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-overlay">
                <div class="modal" id="accessible-modal" role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-description">
                    ...
                    <form id="edit-blotter-form" action="adminBlotterUpdate.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" id="edit-case-id" name="case_id" value="">
                        <input type="hidden" id="account-id-add" name="account_id" value="<?= $_SESSION['account_id'] ?>">
...
function populateBlotterModal(button) {
    ...
    var basePath = '../../img/image_evidences/blotter/';  // Ensure this matches your server structure
