...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        // Define the status to be updated (e.g., "closed")
        $status = 'closed';
        ...
        if ($adminReportModel->updateReportStatus($conn, $tableName, $caseId, $status, $remarks)) {
            ...
            $_SESSION['message'] = "The report has been successfully closed.";
            ...
            $_SESSION['message'] = "Failed to close the report.";
        ...
        echo "Error closing report: " . $e->getMessage();
