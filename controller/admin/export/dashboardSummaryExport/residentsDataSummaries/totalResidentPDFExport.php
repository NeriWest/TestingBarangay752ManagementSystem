...
class PDFWithHeaderFooter extends FPDF {
    ...
    function Header() {
        // Add images
        $this->Image('../../../../../img/Barangay Logo.png', 83, 5, 20);
        $this->Image('../../../../../img/lunsgodNgMayNilaLogo.png', 195, 5, 20);

        // Report header
        $this->SetFont('Arial', 'B', 16);
        $this->Cell(0, 10, 'TOTAL RESIDENT LIST REPORT', 0, 1, 'C');
        ...
        $this->Cell(0, 6, 'Total Residents: ' . $GLOBALS['residentCount'], 0, 1, 'C');
        $this->Ln(8);
...
foreach ($residents as $resident) {
    ...
    $cells = [
        $resident['last_name'],
        $resident['first_name'],
        empty($resident['middle_name']) ? 'N/A' : $resident['middle_name'],
