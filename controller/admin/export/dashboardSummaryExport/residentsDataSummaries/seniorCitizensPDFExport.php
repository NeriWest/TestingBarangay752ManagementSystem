...
class PDFWithHeaderFooter extends FPDF {
    ...
    function Header() {
        // Add images
        $this->Image('../../../../../img/Barangay Logo.png', 74, 5, 20);
        $this->Image('../../../../../img/lunsgodNgMayNilaLogo.png', 204, 5, 20);

        // Report header
        $this->SetFont('Arial', 'B', 16);
        $this->Cell(0, 10, 'TOTAL SENIOR CITIZENS LIST REPORT', 0, 1, 'C');
        ...
        $this->Cell(0, 6, 'Total Senior Citizens: ' . $GLOBALS['residentCount'], 0, 1, 'C');
        $this->Ln(8);
...
$headers = [
    ...
    ['width' => 17, 'title' => 'Middle Name'],
    ['width' => 9, 'title' => 'Suffix'],
    ['width' => 10, 'title' => 'Sex'],
    ['width' => 7, 'title' => 'Age'],
    ['width' => 15, 'title' => 'Birthdate'],
    ['width' => 15, 'title' => 'Civil Status'],
    ['width' => 16, 'title' => 'Mobile No.'],
    ['width' => 30, 'title' => 'Email'],
    ['width' => 10, 'title' => 'House No.'],
    ['width' => 15, 'title' => 'Street'],
    ['width' => 30, 'title' => 'Address'],
    ['width' => 16, 'title' => 'Citizenship'],
    ['width' => 12, 'title' => 'Voter Status'],
    ['width' => 11, 'title' => 'Status'],
    ['width' => 20, 'title' => 'Occupation'],
    ['width' => 20, 'title' => 'Disability']
];
...
// Output
$pdf->Output('Total_Senior_Citizens_PDF_Export_('.date('m-d-Y').').pdf', 'I');
?>