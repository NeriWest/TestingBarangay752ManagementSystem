...
$requests = $adminResidentModel->GETcomplaintsReportedToday($conn, 0, 0);
...
$sheet->getColumnDimension('B')->setWidth(30); // Complainant
$sheet->getColumnDimension('C')->setWidth(20); // Complainant Type
$sheet->getColumnDimension('D')->setWidth(30); // Subject
$sheet->getColumnDimension('E')->setWidth(25); // Official
$sheet->getColumnDimension('F')->setWidth(15); // Date of Incident
...
$sheet->getColumnDimension('N')->setWidth(20); // Status
...
$sheet->getStyle('A2:N'.($rowNumber-1))->applyFromArray([
    'borders' => [
        'allBorders' => [
            'borderStyle' => Border::BORDER_THIN,
            'color' => ['rgb' => '000000']
...
header('Content-Disposition: attachment;filename="Complaints_Reported_Today_Excel_Export_('.date('m-d-Y').').xlsx"');
