...
$requests = $adminResidentModel->GETblottersReportedToday($conn, 0, 0);
...
header('Content-Disposition: attachment;filename="Blotters_Reported_Today_Excel_Export'.date('Y-m-d').'.xlsx"');
