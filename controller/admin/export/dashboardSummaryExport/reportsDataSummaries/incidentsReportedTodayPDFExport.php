...
class PDFWithHeaderFooter extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 10, 'TODAY\'S REPORTED INCIDENTS LIST', 0, 1, 'C');
        ...
        $this->Cell(0, 6, 'New Incidents: ' . $GLOBALS['totalRequestsToday'], 0, 1, 'C');
        $this->Ln(8);
...
$reports = $adminResidentModel->GETincidentsReportedToday($conn, 0, 0); // Get data for today (no pagination needed here)
...
$pdf->Output('Incidents_Reported_Today_PDF_Export_('.date('m-d-Y').').pdf', 'I');
?>
