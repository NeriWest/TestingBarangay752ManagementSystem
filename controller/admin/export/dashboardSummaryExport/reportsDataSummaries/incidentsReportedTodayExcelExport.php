...
$requests = $adminResidentModel->GETincidentsReportedToday($conn, 0, 0);
...
header('Content-Disposition: attachment;filename="Incidents_Reported_Today_Excel_Export_('.date('m-d-Y').').xlsx"');
