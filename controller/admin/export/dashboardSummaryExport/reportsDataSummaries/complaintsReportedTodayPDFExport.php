...
class PDFWithHeaderFooter extends FPDF {
    ...
    function Header() {
        // Logos
        $this->Image('../../../../../img/Barangay Logo.png', 73, 5, 20);
        $this->Image('../../../../../img/lunsgodNgMayNilaLogo.png', 205, 5, 20);

        // Title
        $this->SetFont('Arial', 'B', 16);
        $this->Cell(0, 10, 'TODAY\'S REPORTED COMPLAINTS LIST', 0, 1, 'C');
        ...
        $this->Cell(0, 6, 'New Complaints: ' . $GLOBALS['totalRequestsToday'], 0, 1, 'C');
        $this->Ln(8);
...
$reports = $adminResidentModel->GETcomplaintsReportedToday($conn, 0, 0); // Get data for today (no pagination needed here)
...
$pdf->Output('Complaints_Reported_Today_PDF_Export_('.date('m-d-Y').').pdf', 'I');
?>
