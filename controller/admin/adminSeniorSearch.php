...
if (isset($_POST['query'])) {
    ...
    $residents = $adminResidentModel->searchSeniorResidents($conn, $query);
    ...
    if (!empty($residents)) {
        ...
        foreach ($residents as $resident) {
            ...
            echo "<td>" . htmlspecialchars($resident['osca_id']) . "</td>";
            echo "<td>" . htmlspecialchars($resident['osca_date_issued']) . "</td>";
            ...
            echo '<button class="modal-open button" aria-haspopup="true"  style="background-color:rgb(92, 92, 92);"
                ...
                data-osca-id="' . htmlspecialchars($resident['osca_id']) . '"
                data-osca-date-issued="' . htmlspecialchars($resident['osca_date_issued']) . '"
        ...
        echo "<tr><td colspan='20'>No seniors found.</td></tr>";
    }
}
?>
