...
$requests = $adminCertificateRequestModel->showClearanceRequestsWithPagination($conn, $offset, $recordsPerPage);

// Get the total number of certificate requests (for pagination calculation)
$totalCertificateRequests = $adminCertificateRequestModel->getTotalClearanceRequests($conn);
...
$typeOfDocument = $adminCertificateRequestModel->getTypeOfDocumentClearances($conn);
