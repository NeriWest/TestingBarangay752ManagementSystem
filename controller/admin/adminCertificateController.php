...
$requests = $adminCertificateRequestModel->showCertificateRequestsWithPagination($conn, $offset, $recordsPerPage);

// Get the total number of certificate requests (for pagination calculation)
$totalCertificateRequests = $adminCertificateRequestModel->getTotalCertificateRequests($conn);
...
$typeOfDocument = $adminCertificateRequestModel->getTypeOfDocumentCertificates($conn);
...
require '../../public/views/admin/adminCertificates.php';
