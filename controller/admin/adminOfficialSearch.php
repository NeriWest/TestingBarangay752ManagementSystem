<?php
require_once '../../model/admin/adminOfficialModel.php';
...
if (isset($_POST['query'])) {
    ...
    // Fetch officials based on the search query
    $officials = $adminOfficialModel->searchOfficials($conn, $query);
    ...
    if (!empty($officials)) {
        foreach ($officials as $official) {
            ...
            data-last-name="' . $official['last_name'] . '"
            data-first-name="' . $official['first_name'] . '"
            data-middle-name="' . $official['middle_name'] . '"
